...
class ColorfulClocksFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_colorful_clocks, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val listOfClockView = listOf(
            ...
            view.findViewById<ClockView>(R.id.clockView6),
            view.findViewById<ClockView>(R.id.clockView7),
        )


        val fabForward = view.findViewById<FloatingActionButton>(R.id.fab_forward)
        fabForward.setOnClickListener {
            view.findNavController().navigate(R.id.action_colorfulClocksFragment_to_differentSizeClocksFragment)
        }

        val fabBackwards = view.findViewById<FloatingActionButton>(R.id.fab_backwards)
        fabBackwards.setOnClickListener {
            view.findNavController().navigate(R.id.action_colorfulClocksFragment_to_fullScreenClockFragment)
        }
